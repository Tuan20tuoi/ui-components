...
export interface ProfileFrameProps extends Omit<
    ...
    >
      ...
      {error && (
        <div className={errorClasses}>
          <div className="profile-frame-error__title">
            ⚠️ Không thể load profile
          </div>
          <div className="profile-frame-error__message">
            Website có thể đã chặn việc hiển thị trong iframe do chính sách bảo
            mật (X-Frame-Options).
            <br />
